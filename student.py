...
class loginpage():
    def __init__(self,window):
        ...
        self.button=Button(window,text="login", width=10, height=1, bg="light pink",command=login).place(x=140,y=150)
class window2:
    def __init__(self,window):
        def open_page():
            self.new_window=Toplevel(window)
        ...
        self.text=Label(window,text="STUDENT MANAGEMENT SYSTEM",font=("Calibri",35, "bold"),bg="light pink",bd=6, relief=GROOVE,width=50).place(x=40,y=10)
        self.lframe=LabelFrame(window,text="Menu",bg="white",bd=5,relief=GROOVE,width=1000,height=100,font=("Calibri",15, "bold")).place(x=100,y=170)
        self.submitbutton=Button(window,text="Courses",width=12,command=open_page, font=("Calibri", 10, "italic"), fg="black", bg="blue", relief=RIDGE, bd=10).place(x=130,y=200)
        self.studentbutton=Button(window,text="Student",width=12,command=open_page1,font=("Calibri", 10, "italic"), fg="black", bg="blue", relief=RIDGE, bd=10).place(x=350,y=200)
        ...
        self.resultsbutton=Button(window,text="Logout",command=logout_1,width=12,font=("Calibri", 10, "italic"), fg="black", bg="blue", relief=RIDGE, bd=10).place(x=1000,y=200)
